...
# Coverage: Get-RemuxPreflight extins, av_mux.ps1 markers (remux + demux),
#           Invoke-HdrDvTools refactor.
# NB: matricea Get-RemuxStreamCompat → test_v94_remux_compat.ps1 (v94/O12).
