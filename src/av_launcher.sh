...
export HW_BACKEND HW_PRESET_SLOT \
       ...
       MC_SOC_VERIFIED MC_CAP_HEVC10 MC_CAP_AV1 MC_INPUT_10BIT \
       ...
       MEDIACODEC_HDR_POLICY HW_FORCE DOVI_PRESERVE_POLICY
...
HDR10_MEASURE_CLL="${HDR10_MEASURE_CLL:-0}"
...
DOVI_PRESERVE_POLICY="${DOVI_PRESERVE_POLICY:-}"
DJI_PRESERVE_META="${DJI_PRESERVE_META:-}"
PROFEOF
